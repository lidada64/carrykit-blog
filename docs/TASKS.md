...
- [ ] **M0-1 初始化项目**:`create-next-app`(TypeScript、App Router、Tailwind、src 目录、ESLint);配置 `next.config` `output: "standalone"`;安装 gsap、@gsap/react、Prisma 等锁定依赖
  - 验收:`npm run dev` 与 `npm run build` 均通过
